...
namespace Language_en {
  ...
  PROGMEM Language_Str WELCOME_MSG                         = MACHINE_NAME _UxGT("is Alive.");
  ...
  PROGMEM Language_Str MSG_MEDIA_INSERTED                  = _UxGT("Penis Inserted");
  PROGMEM Language_Str MSG_MEDIA_REMOVED                   = _UxGT("Penis Removed");
  PROGMEM Language_Str MSG_MEDIA_WAITING                   = _UxGT("Waiting for penis");
  PROGMEM Language_Str MSG_MEDIA_READ_ERROR                = _UxGT("Penis broken");
  ...
  PROGMEM Language_Str MSG_STOP_PRINT                      = _UxGT("Oh Shit!");
  ...
  PROGMEM Language_Str MSG_MEDIA_MENU                      = _UxGT("Melty the Plastic?");
  ...
  PROGMEM Language_Str MSG_PRINT_ABORTED                   = _UxGT("You Fucked Up");
  ...
  PROGMEM Language_Str MSG_FILAMENTCHANGE                  = _UxGT("Stick it in");
  PROGMEM Language_Str MSG_FILAMENTCHANGE_E                = _UxGT("Stick it in *");
  PROGMEM Language_Str MSG_FILAMENTLOAD                    = _UxGT("Inserting Now");
  PROGMEM Language_Str MSG_FILAMENTLOAD_E                  = _UxGT("Inserting Now *");
  PROGMEM Language_Str MSG_FILAMENTUNLOAD                  = _UxGT("Pulling out");
  PROGMEM Language_Str MSG_FILAMENTUNLOAD_E                = _UxGT("Pulling Out *");
  ...
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY                 = _UxGT("FIRE FIRE FIRE");
